...
$module_name = "จัดการผู้ใช้งานระบบ";
...
if (isset($_POST["action"])) {
  ...
  switch ($x) {
    case "reset_password"://reset password
      $mc->reset_password($_POST['mem_id'], "index.php?a=รีเซ็ตรหัสผ่านเรียบร้อยแล้ว");
      //echo "reset_password";
      break;
    case "mem_status"://reset password
      $mc->change_status_member($_POST['mem_id'], $_POST["mem_status"], "index.php");
...
<div class="section mt-2" >
  ...
  <div class="card col-12  ">
    <div class="card-header text-center ">
      <span class='h3 mt-2'><i class="fas fa-users"></i> จัดการผู้ใช้งานระบบ <?= @$filter_text; ?></span>
    </div>
    <div class="card-body">
