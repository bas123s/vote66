...
//file_put_contents("response8.php", '<?php $province=' . var_export($data1, true) . '; $amphoe=' . var_export($data2, true) . '; $tambol=' . var_export($data3, true) . '; $mm=' . var_export($data4, true) . '; ? >');
file_put_contents("response.php", '<?php $province=' . var_export($data1, true) . '; $amphoe=' . var_export($data2, true) . '; $tambol=' . var_export($data3, true) . '; ?>');
echo "complete";
?>