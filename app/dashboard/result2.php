    ...
    <div class="col  ">
      <div style="background-color: #2D2C41;" class="p-3    rounded    text-center shadow-lg">
        ...
        <h1 class=" fw-bolder "><span class="text-white d-inline">
		  ...
		  <!--  < ?php echo number_format($percentage_show1, 0);?> % ของเขตเลือกตั้ง 367 เขต -->
      คิดเป็น	100 % ของเขตเลือกตั้ง 400 เขต 	  </span>
...
<section class="py-2 ">
  <div class=" px-5 pb-5">
    <div class="row gx-5 align-items-center g-2 g-lg-2">

      <div class="col-xxl-7 my-3  bg-white rounded shadow "  style="background-color: #FFFEFE; height: 600px;" >
          ...
          <tbody>
            ...
            foreach ($data_party as $key => $value) {
              ...
              <tr class="border-bottom">
                ...
                <td class="display-6"><?php if($value['pp_no']==31) echo $value['cnt']+33; else echo $value['cnt'] ?></td>
                <td><?= $value['pp_name'] ?></td>
      ...
      <div class="col-xxl-5  my-3 rounded " style="height : 600px background-color: #2D2C41;" >
        <?php require 'charts/pie.php'; ?>
      </div>
