...
switch ($data_type2[0]) {
  ...
  if ($data_value == "") {
    ...
    $mc->list_option4($tambol[substr($data_value, 0, 2)][$data_value], "tcode[]", "form-select ", $selected, " ", "กรุณาเลือกตำบล");
//   $mc->list_option5($tambol[substr($data_value, 0, 2)][$data_value], "tcode", "form-select ", $selected, " ", "กรุณาเลือกตำบล");
  ...
  case "amphoe":
   ...
   $mc->list_option4(@$amphoe[$data_value], "acode[]", "form-select ", $selected, " onChange=\"dochange2('tambol_".$id."', this.value,'',".$id.");\" ", "กรุณาเลือกอำเภอ");
  ...
  default:// "province"
   ...
   $mc->list_option4($province, "pcode[]", "form-select ", $selected, " onChange=\"dochange2('amphoe_".$id."', this.value,'',".$id.");\" ", "กรุณาเลือกจังหวัด");
